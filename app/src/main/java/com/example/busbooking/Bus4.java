...
public class Bus4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        String t_name = "JKL Travels";
        String time = "6:00 PM";
        String amount = "Rs 900";
        ...
        Seat.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_seat", "A1");
        ...
        Seat8.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "D2");
        ...
        Seat13.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "A4");
        ...
        Seat14.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "B4");
        ...
        Seat19.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "C5");
        ...
        Seat21.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "A6");
        ...
        Seat23.setOnClickListener(v -> {
            ...
            intent_seat.putExtra("message_key_t_name", t_name);
            intent_seat.putExtra("message_key_amount", amount);
            intent_seat.putExtra("message_key_seat", "C6");

            startActivity(intent_seat);
        });
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) View Seat24 = findViewById(R.id.seat24);
        Seat24.setOnClickListener(v -> {
            Toast.makeText(Bus4.this, "This seat is already booked!!", Toast.LENGTH_SHORT).show();
        });
    }
}
